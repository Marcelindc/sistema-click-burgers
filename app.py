...
with st.sidebar:
    ...
    # Abas Restauradas à sua vontade!
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.caption("Sistema Cloud v3.1 - Click Burgers")
...
# -------------------------------------------------------------
# MÓDULO 6: INSUMOS (FICHA TÉCNICA) - SEPARADO!
# -------------------------------------------------------------
        ...
        if insumo_selecionado != "-- Escolha --":
            ...
            with st.form("form_editar_insumo"):
                ...
                if st.form_submit_button("Atualizar e Recalcular Fichas"):
                    ...
                    puxar_dados.clear() 
                    st.success("✅ Insumo atualizado e Lanches recalculados!")
...
# -------------------------------------------------------------
# MÓDULO 7: LISTA DE COMPRAS INDEPENDENTE (COM CORES)
# -------------------------------------------------------------
